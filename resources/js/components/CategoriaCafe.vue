    ...
    <div class="container my-5">
        ...
        <div class="row">
            <div class="col-md-4 mt-4" v-for="cafe in cafes" v-bind:key="cafe.id">
                <div class="card">
                    <img class="card-img-top" :src="`storage/${cafe.imagen_principal}`" alt="img-cafe"> 
                    <!-- image for no porduction //<img class="card-img-top show-main" :src="`images/${cafe.imagen_principal}.jpg`" alt="img-cafe">-->
                    <div class="card-body">
